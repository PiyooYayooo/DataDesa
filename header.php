...
<head>
  ...
  <title>SISTEM INFORMASI KEPENDUDUKAN DESA SUDIPAYUNG</title>
...
<div class="wrapper">
  <header class="main-header">
    <a href="beranda.php" class="logo">
      ...
      <span class="logo-lg"><b>DESA SUDIPAYUNG</span>
    </a>
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          <li>
            <a href="#" data-toggle="control-sidebar"><marquee><i class="fa fa-mortar-board"> </i>  Perancangan Sistem Informasi  Kependudukan pada Kantor Kab Kuantan Singingi Berbasi Web </marquee></a>
          </li>
        </ul>
      </div>
    </nav>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
       <div class="anic">
        ...
        <h4>Sistem Informasi Penduduk DESA SUDIPAYUNG</h4>
