...
<head>
  ...
  <title>Login - Data Penduduk SUDIPAYUNG</title>
...
<body class="hold-transition login-page">
  ...
  <header class="wrapper head">
    <div class="box">
      <video src="pacujalur.MP4" autoplay loop="true"></video>
    </div>
    <div class="content">
    <div class="login-box">
  <div class="login-logo">
    <font color='white' face="Snap ITC">WELCOME TO SUDIPAYUNG</font><br>
  </div>
